...
Miniflux server role providing an OCI container deployment with external PostgreSQL, Caddy TLS reverse proxy, optional kanidm OIDC authentication, borgbackup state, and firewall configuration.
