...
Himalaya client-only service providing multi-account email management via the himalaya CLI, with skill delegation and secretspec-based password management.
