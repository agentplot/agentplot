...
OpenClaw server role providing the gateway deployment with Caddy HTTPS, model providers, agents, messaging channels, plugin support, and clan vars secret management, ported from swancloud.
