...
Module option that extracts evaluated Home Manager config into a JSON-serializable structure, enabling cross-machine capability inventory and dashboard generation.
